'use client'
import { Box, Flex, VStack, Text, Icon, useColorModeValue, Tooltip } from "@chakra-ui/react"
...
export const SidebarContentNav = ({ onClose, isMinimized, toggleMinimized, ...rest }: { onClose: () => void, isMinimized: boolean, toggleMinimized: () => void, [key: string]: any }) => {
